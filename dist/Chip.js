...
exports.Chip = style_1.styled(ChipImpl).attrs(function (p) { return ({
    titleColor: contrastingColor_1.contrastingColor(p.color),
    hoverColor: polished_1.transparentize(0.4, contrastingColor_1.contrastingColor(p.color)),
}); })(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: inline-flex;\n  align-items: center;\n  background-color: ", ";\n  border-radius: 12px;\n  color: ", ";\n  font-size: 85%;\n  flex-direction: row;\n  height: 24px;\n  overflow: hidden;\n  margin-right: 3px;\n  padding: 0 5px;\n  user-select: none;\n  white-space: nowrap;\n\n  &.small {\n    height: 21px;\n    font-size: 75%;\n    border-radius: 10px;\n  }\n\n  &.smaller {\n    height: 18px;\n    font-size: 70%;\n    border-radius: 9px;\n  }\n\n  &.mini {\n    height: 16px;\n    font-size: 65%;\n    border-radius: 8px;\n  }\n\n  .title {\n    margin-right: 4px;\n    margin-left: 4px;\n  }\n\n  > .close {\n    align-items: center;\n    border: none;\n    color: ", ";\n    cursor: pointer;\n    background-color: transparent;\n    display: flex;\n    height: 16px;\n    justify-content: center;\n    margin-right: -4px;\n    outline: none;\n    padding: 0;\n    position: relative;\n    top: 1px;\n    width: 16px;\n    font-weight: bold;\n\n    &:hover {\n      color: ", ";\n    }\n  }\n"], ["\n  display: inline-flex;\n  align-items: center;\n  background-color: ", ";\n  border-radius: 12px;\n  color: ", ";\n  font-size: 85%;\n  flex-direction: row;\n  height: 24px;\n  overflow: hidden;\n  margin-right: 3px;\n  padding: 0 5px;\n  user-select: none;\n  white-space: nowrap;\n\n  &.small {\n    height: 21px;\n    font-size: 75%;\n    border-radius: 10px;\n  }\n\n  &.smaller {\n    height: 18px;\n    font-size: 70%;\n    border-radius: 9px;\n  }\n\n  &.mini {\n    height: 16px;\n    font-size: 65%;\n    border-radius: 8px;\n  }\n\n  .title {\n    margin-right: 4px;\n    margin-left: 4px;\n  }\n\n  > .close {\n    align-items: center;\n    border: none;\n    color: ", ";\n    cursor: pointer;\n    background-color: transparent;\n    display: flex;\n    height: 16px;\n    justify-content: center;\n    margin-right: -4px;\n    outline: none;\n    padding: 0;\n    position: relative;\n    top: 1px;\n    width: 16px;\n    font-weight: bold;\n\n    &:hover {\n      color: ", ";\n    }\n  }\n"])), function (p) { return p.color; }, function (p) { return p.titleColor; }, function (p) { return p.hoverColor; }, function (p) { return p.titleColor; });
