...
function DropdownButton(_a) {
    var _b = _a.drop, drop = _b === void 0 ? 'down' : _b, disabled = _a.disabled, checkable = _a.checkable, size = _a.size, _c = _a.alignEnd, alignEnd = _c === void 0 ? false : _c, className = _a.className, children = _a.children, title = _a.title, variant = _a.variant, onSelect = _a.onSelect;
    ...
    return (React.createElement(react_overlays_1.Dropdown, { show: shown, onToggle: function (show) { return setShown(show); }, drop: drop, alignEnd: alignEnd, itemSelector: "button:not(:disabled)" }, function (_a) {
        ...
        return (React.createElement(DropdownContainer, __assign({}, props),
            ...
            React.createElement(react_overlays_1.Dropdown.Menu, { flip: true }, function (_a) {
                ...
                return show && (React.createElement(Menu_1.Menu, __assign({}, menuProps, { checkable: checkable, onClick: onMenuClick }), children));
            })));
    }));
}
