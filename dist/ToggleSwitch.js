...
exports.InsetToggleSwitch = style_1.styled(ToggleSwitchImpl)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: none;\n  border: none;\n  cursor: pointer;\n  outline: none;\n  padding: 0;\n  position: relative;\n\n  &[disabled] {\n    opacity: 0.4;\n    cursor: default;\n  }\n\n  > .slide {\n    background-color: ", ";\n    border-radius: 11px;\n    box-shadow: inset 0 1px 1px 1px ", ";\n    height: 22px;\n    transition: background-color linear 0.2s;\n    width: 38px;\n  }\n\n  &:focus > .slide {\n    box-shadow: 0 0 0 3px ", ";\n    z-index: 1;\n  }\n\n  > .thumb {\n    background-color: ", ";\n    border-radius: 9px;\n    height: 18px;\n    top: 2px;\n    left: 2px;\n    position: absolute;\n    transition: transform linear 0.2s, background-color linear 0.3s;\n    width: 19px;\n  }\n\n  &.checked {\n    > .slide {\n      background-color: ", ";\n    }\n    > .thumb {\n      transform: translateX(15px);\n      background-color: ", ";\n    }\n  }\n"], ["\n  background: none;\n  border: none;\n  cursor: pointer;\n  outline: none;\n  padding: 0;\n  position: relative;\n\n  &[disabled] {\n    opacity: 0.4;\n    cursor: default;\n  }\n\n  > .slide {\n    background-color: ", ";\n    border-radius: 11px;\n    box-shadow: inset 0 1px 1px 1px ", ";\n    height: 22px;\n    transition: background-color linear 0.2s;\n    width: 38px;\n  }\n\n  &:focus > .slide {\n    box-shadow: 0 0 0 3px ", ";\n    z-index: 1;\n  }\n\n  > .thumb {\n    background-color: ", ";\n    border-radius: 9px;\n    height: 18px;\n    top: 2px;\n    left: 2px;\n    position: absolute;\n    transition: transform linear 0.2s, background-color linear 0.3s;\n    width: 19px;\n  }\n\n  &.checked {\n    > .slide {\n      background-color: ", ";\n    }\n    > .thumb {\n      transform: translateX(15px);\n      background-color: ", ";\n    }\n  }\n"])), function (p) { return p.theme.insetToggle.slideColor; }, function (p) { return p.theme.shadowColor; }, function (p) { return p.theme.focusColor; }, function (p) { return p.theme.insetToggle.thumbColor; }, function (p) { return p.theme.insetToggle.checkedSlideColor; }, function (p) { return p.theme.insetToggle.checkedThumbColor; });
